...
class PPO(object):  
    ...
    def _build_anet(self, name, trainable): 
        ...
        return norm_dist, params    # Retorna a ação e os pesos atuais das redes para serem armazenados na
                                    # politica antiga.
    ...
    def get_v(self, s):             # Recebe o estado s e retorna o valor da taxa de aprendizagem da
                                    # CRITICA
